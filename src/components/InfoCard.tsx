...
export function InfoCard({ pin, onClose }: InfoCardProps) {
  // Close on Escape key
  useEffect(() => {
  ...
  const upzColor = pin ? getUPZColor(pin.upz) : '#00f3ff';
      ...
      {pin && (
        <>
          ...
          <motion.div
            ...
            style={{
              borderLeftColor: `${upzColor}30`,
              boxShadow: `-10px 0 40px ${upzColor}10`,
            }}
          >
            {/* Header */}
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <motion.h2
                    ...
                    style={{ color: upzColor, textShadow: `0 0 15px ${upzColor}40` }}
                  >
                    {pin.titulo}
                  </motion.h2>
                </div>
            ...
            <div className="px-6 py-6 space-y-6">
              ...
              >
                <span
                  ...
                  style={{
                    color: upzColor,
                    borderColor: `${upzColor}40`,
                    background: `${upzColor}10`,
                  }}
                >
              ...
              {pin.direccion_referencia && (
                ...
                >
                  ...
                  <span>{pin.direccion_referencia}</span>
                </motion.div>
              )}
              ...
              >
                <span>Lat: {pin.latitud.toFixed(6)}</span>
                <span className="text-slate-700">|</span>
                <span>Lng: {pin.longitud.toFixed(6)}</span>
              </motion.div>
              ...
              >
                <h3 className="text-sm font-semibold text-slate-200 flex items-center gap-2">
                  <div
                    ...
                    style={{ background: upzColor, boxShadow: `0 0 6px ${upzColor}` }}
                  />
                  Imagen
                </h3>
                <div
                  className="rounded-xl overflow-hidden border"
                  style={{ borderColor: `${upzColor}20` }}
                >
                  <img
                    src={pin.imagen_url}
                    alt={pin.titulo}
              ...
              >
                ...
                <span>
                  Creado: {new Date(pin.creado_at).toLocaleDateString('es-CO')}
                </span>
              </motion.div>
            </div>
          </motion.div>
